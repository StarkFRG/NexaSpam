...
from Nexa.helper.basic import edit_or_reply, get_text, get_user
from Nexa.modules.help import add_command_help
from Nexa.helper.functions import user_only, user_errors, delete_reply, Owner, Sudos, Devs
...
async def _revert(client: Client, message: Message):
    ...
    user_bio = Bio or "💕ɪ ᴀᴍ ᴘᴀʀᴛ ᴏғ sᴛᴀʀᴋ💕"
