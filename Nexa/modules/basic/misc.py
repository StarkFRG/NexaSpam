...
from Nexa import START_TIME
from Nexa import SUDO_USER
from Nexa.helper.PyroHelpers import ReplyCheck
from Nexa.modules.help import add_command_help
from Nexa.modules.bot.inline import get_readable_time

alive_logo = ALIVE_PIC or "https://files.catbox.moe/9ux4mb.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **𝐒ᴜᴘᴘᴏʀᴛ**: [Click](https://t.me/NexaCoders)\n"
        f"├• **𝐔ᴘᴅᴀᴛᴇ**: [Click](https://t.me/NexaCoders)\n"
        f"└• **𝐇ᴏᴛᴇʀ**: [Click](https://t.me/NexaCoders)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Ⰶ ʜᴇʀᴇ ɪs ғʀᴇᴇ Nᴇxᴀ ᴜsᴇʀʙᴏᴛ ʜᴏsᴛᴇʀ: \n\n[Nᴇxᴀ](https://t.me/NexaCoders)\n\nⰆ ᴄʟᴏɴᴇ ʏᴏᴜʀ ᴘʏʀᴏɢʀᴀᴍ sᴇssɪᴏɴ & ᴇɴᴊᴏʏ")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("@URSTARKZ")
