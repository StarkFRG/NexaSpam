...
class Data:
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton("⚡ ᴜᴘᴅᴀᴛᴇ's", url="https://t.me/NexaCoders"),
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ ⛈️️", url="https://t.me/NexaMeetup")
        ],
        [InlineKeyboardButton("🌿 ʙᴏᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ 🌿", url="https://t.me/urstarkz")],
    ]

    START = """
**┌────── ˹ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ˼ ⏤͟͟͞͞‌‌‌‌★**
**┆◍ ʜᴇʏ, ɪ ᴀᴍ : [ 𝐍𝐞𝐱𝐚 ✘ 𝐇ᴏꜱᴛᴇʀ˼]**
**┆● ɴɪᴄᴇ ᴛᴏ ᴍᴇᴇᴛ ʏᴏᴜ !** 
**└────────────────────────•**
...
"""
    ...
    GUIDE = """**❖ ʜᴇʏ ᴅᴇᴀʀ, ᴛʜɪs ɪs ᴀ ǫᴜɪᴄᴋ ᴀɴᴅ sɪᴍᴘʟᴇ ɢᴜɪᴅᴇ ᴛᴏ ʜᴏsᴛɪɴɢ [ᴜsᴇʀʙᴏᴛ](https://t.me/Nexaub_Bot)**
...
**◌ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : [𝐍𝐞𝐱𝐚](https://t.me/NexaCoders)**
**◌ ᴅᴇᴠᴇʟᴏᴘᴇʀ : [𝐒𝐭𝐚𝐫𝐤](https://t.me/urstark)**
"""
...
**• ʏᴏᴜ ᴄᴀɴ ᴅᴏɴᴀᴛᴇ ʙʏ ᴄᴏɴᴛᴀᴄᴛɪɴɢ [ᴅᴇᴠᴇʟᴏᴘᴇʀ](https://t.me/NexaCoders) 🚩**

**ʏᴏᴜʀ sᴍᴀʟʟ ᴀᴍᴏᴜɴᴛ ᴄᴀɴ ʜᴇʟᴘ ᴜs ᴀɴᴅ sᴛᴀʀᴋ ᴛᴏ ɢʀᴏᴡ ᴍᴏʀᴇ**
"""
